...
# METODOS
def u_print(text, end_="\n"):
    print(user + text, end=end_)


def dm_print(text, end_="\n"):
    #print(dm + text, end=end_)
    for let in text:
        print("{}{}".format(dm,let), end="")
        sleep(0.01)
    print("",end=end_)
...
def case3():
    ...
    sleep(TIME)
    u_print(
            "[a] Actually Tolkein is a hack. Gimme something DIFFERENT.\n"
            + "[b] Me too!\n"
            )
...
def case4():
    ...
    sleep(TIME)
    u_print(
            "[a] I'm DARK and MISUNDERSTOOD and there's no true RIGHT or WRONG\n"
            + "[b] I want to be a MOTHERFUCKING dragon\n"
            + "[c] Uh, I dunno, just make me not an elf, dwarf, angel, devil or something done 100 times before okay\n"
            )
...
def case10():
    ...
    sleep(TIME)
    u_print(
            "[a] Yeah I still wanna be magical and pretty\n"
...
def case11():
    ...
    sleep(TIME)
    u_print(
            "[a] I would like to maintain some semblance of gravitas\n"
...
def case14():
    ...
    sleep(TIME)
    u_print(
            "[a] No one gets me, especially my Mom\n"
...
def case17():
    ...
    sleep(TIME)
    u_print(
            "[a] ... you're right. Let's stick to something at least a bit familiar\n"
            + "[b] Yeah. Fuck you\n"
            )
...
def case22():
    ...
    sleep(TIME)
    u_print(
            "[a] By Thorin's beard, time to drink ale and axe things!\n"
...
def case24():
    ...
    sleep(TIME)
    u_print(
            "[a] I'm the DARK AND BADASS version of some poncy elf, dwarf, or other wussy fantasy goody two shoes\n"
...
def case25():
    ...
    sleep(TIME)
    u_print(
            "[a] Can't spell Slaughter without Laughter\n"
...
def case29():
    ...
    sleep(TIME)
    u_print(
            "[a] I just wanna soar in the air majestic and free\n"
...
def case33():
    ...
    sleep(1)
    u_print(
            "[a] I wanted to be Dark and Brooding\n"
...
def case35():
    ...
    sleep(1)
    u_print(
            "[a] I'm quick and lithe, like an elf but DARK\n"
...
def case38():
    ...
    sleep(1)
    u_print(
            "[a] Wait, can I do this but more Elf-y?\n"
            + "[b] Yeah!\n"
            )
...
def case39():
    ...
    sleep(1)
    u_print(
            "[a] Well, there's only one REAL choise...\n"
            + "[b] Rock Hard baby\n"
...
def case40():
    ...
    sleep(1)
    u_print(
            "[a] Okay, that's pretty fucking out there\n"
...
def case42():
    ...
    sleep(1)
    u_print(
            "[a] Face them head on, I'm not a coward!\n"
...
def case43():
    ...
    sleep(1)
    u_print(
            "[a] Deception os the ultimate weapon\n"
...
def case44():
    ...
    sleep(1)
    u_print(
            "[a] Oh I wanna ve an angel but not like goody two shoes A BAD ANGEL\n"
            + "[b] You know, light, goodness, yadda yadda\n"
            + "[c] The path of the righteous man is beset on all sides by the inequities of the selfish "
...
def case45():
    ...
    sleep(1)
    u_print(
            "[a] WE ARE INMORTAL WE ARE CONQUERERS WE ARE GITH\n"
...
def case47():
    ...
    u_print(
            "[a] Yeah!\n"
            + "[b] Wait, what's this Intelligene penalty? I don't want to be stupid, "
            + "can I backpedal a bot and be a bit more heroic?\n"
            )
...
def case49():
    ...
    dm_print(
        "OKAY YOU HAVE TENTACLES AND MUTATIONS AND YOU'RE LITERALLY A MAD SCIENCE EXPERIMENT")
    sleep(1)
    u_print(
            "[a] This is the shit I'm talking about\n"
